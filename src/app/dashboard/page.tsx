...
import { formatNumberToVnCurrency, formatNumberWithCommas, getVietnameseDayOfWeek } from '@/lib/utils'
import type { SearchParams } from '@/types/data-table.type'
import { format, getDate, getMonth, getYear } from 'date-fns'
import { DollarSignIcon, TrendingDownIcon, TrendingUpIcon, Users } from 'lucide-react'
...
export default async function DashboardPage(props: Props) {
  ...
  return (
    <div className='px-2 py-5 md:px-4 lg:px-9'>
      ...
      {/* Charts */}
      <RevenueChart from={search.from} to={search.to} chartData={revenueChartData} />
    </div>
  )
}
