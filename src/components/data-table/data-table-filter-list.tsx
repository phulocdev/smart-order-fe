              ...
              >
                {filter.value && typeof filter.value === 'string' ? (
                  <Badge variant='secondary' className='rounded-sm px-1 font-normal'>
                    {filterField?.options?.find((option) => option.value.toString() === filter.value)?.label ||
                      filter.value}
                  </Badge>
                ) : (
                  <>
                ...
                <FacetedFilterGroup>
                  {filterField?.options?.map((option) => (
                    <FacetedFilterItem
                      ...
                      selected={filter.value === option.value.toString()}
                      onSelect={(value) => {
              ...
              <FacetedFilterList>
                ...
                <FacetedFilterGroup>
                  {filterField?.options?.map((option) => (
                    <FacetedFilterItem
                      key={option.value.toString()}
                      value={option.value.toString().toString()}
                      selected={selectedValues.has(option.value.toString().toString())}
                      onSelect={(value) => {
