...
import type { DataTableFilterField } from '@/types/data-table.type'
...
interface DataTableToolbarProps<TData> extends React.HTMLAttributes<HTMLDivElement> {
  ...
  translateHeaderFunc: <TData>(key: TData) => string
}
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center gap-2'>
        {children}
        <DataTableViewOptions table={table} translateHeaderFunc={translateHeaderFunc} />
      </div>
    </div>
  )
}
